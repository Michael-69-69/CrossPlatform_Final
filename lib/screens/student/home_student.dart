...
// import '../../screens/student/in_app_notification_screen.dart';
...
//         ),
//         actions: [
//           // ✅ BELL NOTIFICATION ICON (Replaces message icon)
//           Stack(
//             children: [
//               IconButton(
...
//                 subtitle: unreadCount > 0 ? Text('$unreadCount chưa đọc', style: const TextStyle(fontSize: 12)) : null,
//                 onTap: () {
//                   Navigator.pop(context);
//                   Navigator.push(
//                     context,
//                     MaterialPageRoute(
//                       builder: (_) => const InAppNotificationScreen(),
//                     ),
//                   );
//                 },
//               );
